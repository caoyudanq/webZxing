...
<div id="wrapper">
	<div id="header">
		...
		<%--<div id="menu">--%>
			<%--<div id="menu_container">--%>
				<%--<ul id="menu_items">--%>
					<%--<li class="menu_item" onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'" onmouseover="this.style.backgroundColor='#77D1F6';this.style.fontWeight='bold'"><a>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>--%>
					<%--<li class="menu_item" onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'" onmouseover="this.style.backgroundColor='#77D1F6';this.style.fontWeight='bold'"><a>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>--%>
					...
					<%--&lt;%&ndash;<li class="menu_item" onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'" onmouseover="this.style.backgroundColor='#77D1F6';this.style.fontWeight='bold'"><a>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>&ndash;%&gt;--%>
					<%--<li class="menu_item" style="border-radius:8px 0 0 8px;border:0px;" onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'" onmouseover="this.style.backgroundColor='#77D1F6';this.style.borderRadius='0 8px 8px 0';this.style.fontWeight='bold'"><a>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>--%>
				<%--</ul>--%>
			<%--</div>--%>
		<%--</div>--%>
		<div id="user_info">
	...
	<div id="footer">Students Information Management System</div>
</div>
</body>
